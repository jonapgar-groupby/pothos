...
export type AddGraphQLInputFieldsShape<Types extends SchemaTypes, Shape> = (t: PothosSchemaTypes.InputFieldBuilder<Types, "InputObject">) => Record<string, null | (InputFieldRef<Types, unknown> & {
